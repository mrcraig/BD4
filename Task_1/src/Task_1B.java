...
public class Task_1B extends Configured implements Tool {
	@Override
	public int run(String[] args) throws Exception {
		...
		job.setJobName("Task 1B");
		job.setJarByClass(Task_1B.class);
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Task_1B(), args));
	}
}